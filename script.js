...
async function ShowData() {
  ...
  await fetch(`https://ipinfo.io/${IPAddress}?token=db03404d02d3d1`)
    .then((response) => response.json())
    ...
    .then((res) => {
      ...
      <h1 id="info">More Information About You</h1>
       ...
       <div class="postOffice">
          ...
          <div class="box">
            <input type="search" name="" id="searchBox" placeholder="Search By Name" onkeyup="searchKey()"/>
            <img src="images/search.png" id="vector-img"alt="" />
          </div>
        </div>
